...
def cli():
    ...
    # vad params
    parser.add_argument("--vad_onset", type=float, default=0.500, help="Onset threshold for Silero VAD, reduce this if speech is not being detected")
    parser.add_argument("--vad_offset", type=float, default=0.363, help="Offset threshold for Silero VAD, reduce this if speech is not being detected.")
    ...
    parser.add_argument("--diarize_model", default="BUT-FIT/diarizen-wavlm-large-s80-md-v2", type=str, help="Name of the DiariZen speaker diarization model to use")
    ...
    parser.add_argument("--hf_token", type=str, default=None, help="Hugging Face access token for model downloads")
